...
const OrderReceivedEmail = ({
  ...
  const baseUrl =
    process.env.NODE_ENV === "development"
      ? "http://localhost:3000"
      : "https://casewise-pied.vercel.app";
  return (
    <Html>
      <Head />
      <Preview>Your order summary and delivery details</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={global.text}>
              We are preparing your order for delivery and will notify you once
              your package has been shipped. Delivery usually takes 3-4 working
              days.
            </Text>
            <Text style={{ ...global.text, marginTop: 24 }}>
              If you have any questions regarding your order, please feel free
              to contact us, please have your order number handy, before you do
